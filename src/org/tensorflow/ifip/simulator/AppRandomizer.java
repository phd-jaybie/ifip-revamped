package org.tensorflow.ifip.simulator;
    ...
    public List<App> fixedAppGenerator(Context context, int numberOfApps){
        ...
        for (int i = 0; i < numberOfApps ; i++){
            ...
            if (first == 0) {
                ...
                // Added a reference image below for the benefit of the IFIP demo.
                // Regular app demo (i.e. Abstraction and USyd) does not require reference for TF.
                reference = cvReferenceImage(context, "SIFT");
            } else {
