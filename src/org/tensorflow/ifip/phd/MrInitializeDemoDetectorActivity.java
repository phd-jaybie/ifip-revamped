 ...
 */
public class MrInitializeDemoDetectorActivity extends MrCameraActivity implements OnImageAvailableListener {
        ...
        addCallback(
                new DrawCallback() {
                    ...
                    public void drawCallback(final Canvas canvas) {
                        ...
                        lines.add("Collected reference objects: " + objectReferenceList.getList().size());
